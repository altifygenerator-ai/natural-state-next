...
export const metadata: Metadata = { title: "Exterior Remodeling & Siding | Hot Springs, AR", description: "Siding, windows, roofing, gutters and exterior remodeling around Hot Springs, Arkansas." };
