...
export const metadata: Metadata = { title: "Interior Remodeling in Hot Springs, AR", description: "Interior remodeling, flooring, drywall, painting and finish work around Hot Springs, Arkansas." };
